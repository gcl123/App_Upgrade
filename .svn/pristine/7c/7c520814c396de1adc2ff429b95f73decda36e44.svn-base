...
(function ($) {
    ...
    function _3c(_3d) {
        ...
        _40.panel($.extend({}, _3f, {
            id: null, doSize: false, onResize: function (_41, _42) {
                setTimeout(function () {
    ...
    $.fn.datagrid.parseOptions = function (_1b4) {
        var t = $(_1b4);
        return $.extend({}, $.fn.panel.parseOptions(_1b4), $.parser.parseOptions(_1b4, ["url", "toolbar", "idField", "sortName", "sortOrder", "pagePosition", {
            fitColumns: "boolean",
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        loader: function (_1df, _1e0, _1e1) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _1df, dataType: "json", success: function (data) {
                    _1e0(data);
                }, error: function () {
