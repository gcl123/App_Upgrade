            ...
            $(".st_tree").SimpleTree({
                click: function (a) {
                    ...
                    if ("welcome" == sref) {
                        ...
                        addTab('App列表', 'jsp/appList.jsp');
                        $("#curMd").text('App管理 > App列表');
                    }
                    else if ("download" == sref) {
                        addTab('工具下载', 'jsp/download.jsp');
                        $("#curMd").text('App管理 > 工具下载');
                    }
                    else if ("appVersionList" == sref) {
                        addTab('版本信息', 'jsp/appVersionList.jsp');
                        $("#curMd").text('当前App > 版本信息');
                    }
                    else if ("uploadIndex" == sref) {
                        addTab('文件上传', 'jsp/uploadIndex.jsp');
                        $("#curMd").text('当前App > 文件上传');
                    }
                    else if ("upload" == sref) {
                        addTab('文件拖放上传', 'jsp/upload.jsp');
                        $("#curMd").text('当前App > 文件拖放上传');
                    }
                    else if ("about" == sref) {
...
<div id="cc" class="easyui-layout" style="width:100%;height:100%;">
    ...
    <div region="north" style="height:96px;width: 100%;">
        ...
        <div id="topmenu" class="topmenu"
            ...
            <a href="javascript:addTab('我的App','project.html')" >我的App</a>
    ...
    <div region="west" title="导航菜单栏" style="width:180px;"><!--easyui-tree-->
        <div class="st_tree">
            <ul>
                ...
                <li><a ref="#">App管理</a></li>
                <ul show="true">
                    <li><a ref="appList">App列表</a></li>
                    <li><a ref="download">工具下载</a></li>
                 </ul>
                <li><a ref="#">当前App</a></li>
                <ul show="true">
                    <li><a ref="appVersionList">版本信息</a></li>
                    <li><a ref="uploadIndex">文件上传</a></li>
                    <li><a ref="upload">文件拖放上传</a></li>
        ...
        <!--ul id="tt1" class="st_tree" data-options="animate:true,dnd:true,lines:true"></ul>
            ...
            <li><span>我的App</span>
                <ul>
                    <li><a href="">浏览App</a></li>
                    <li><a href="">新增App</a></li>
                </ul>
            </li>
            <li><a href="">关于</a></li-->
    </div>
