...
(function ($) {
    ...
    $.fn.searchbox = function (_20, _21) {
        ...
        return this.each(function () {
            ...
            if (_22) {
                ...
                _22 = $.data(this, "searchbox", {
                    options: $.extend({}, $.fn.searchbox.defaults, $.fn.searchbox.parseOptions(this), _20),
                    searchbox: _1(this)
                });
            }
            _a(this);
    ...
    $.fn.searchbox.parseOptions = function (_28) {
        var t = $(_28);
        return $.extend({}, $.parser.parseOptions(_28, ["width", "prompt", "menu"]), {
            value: t.val(),
            searcher: (t.attr("searcher") ? eval(t.attr("searcher")) : undefined)
        });
    };
    $.fn.searchbox.defaults = {
        width: "auto", prompt: "", value: "", menu: null, searcher: function (_29, _2a) {
        }
    };
})(jQuery);
