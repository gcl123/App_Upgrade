...
(function ($) {
    ...
    function _1a(_1b) {
        ...
        if (_1c.options.href && (!_1c.isLoaded || !_1c.options.cache)) {
            ...
            $.ajax({
                url: _1c.options.href, cache: false, success: function (_1f) {
    ...
    $.fn.panel.parseOptions = function (_66) {
        var t = $(_66);
        return $.extend({}, $.parser.parseOptions(_66, ["id", "width", "height", "left", "top", "title", "iconCls", "cls", "headerCls", "bodyCls", "tools", "href", {
            cache: "boolean",
            fit: "boolean",
            border: "boolean",
            noheader: "boolean"
