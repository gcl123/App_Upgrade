...
(function ($) {
    ...
    $.fn.treegrid = function (_9d, _9e) {
        ...
        return this.each(function () {
            ...
            if (_a0) {
                ...
                $.data(this, "treegrid", {
                    options: $.extend({}, $.fn.treegrid.defaults, $.fn.treegrid.parseOptions(this), _9d),
                    data: []
                });
            }
            _5(this);
    ...
    var _ac = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_ad, _ae, _af) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        treeField: null, animate: false, singleSelect: true, view: _ac, loader: function (_ec, _ed, _ee) {
            var _ef = $(this).treegrid("options");
            if (!_ef.url) {
                return false;
            }
            $.ajax({
                type: _ef.method, url: _ef.url, data: _ec, dataType: "json", success: function (_f0) {
                    _ed(_f0);
                }, error: function () {
