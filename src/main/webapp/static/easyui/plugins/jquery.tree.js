...
(function ($) {
    ...
    function _15(_16) {
        ...
        _18.find("div.tree-node").draggable({
            ...
            accept: "div.tree-node", onDragOver: function (e, _1b) {
                var _1c = _1b.pageY;
    ...
    function _37(_bc, _bd) {
        var _be = $.extend({}, $.data(_bd, "tree-node"), {
            target: _bd,
            checked: $(_bd).find(".tree-checkbox").hasClass("tree-checkbox1")
        });
        if (!_43(_bc, _bd)) {
    ...
    $.fn.tree.defaults = {
        ...
        dnd: false,
        data: null,
        loader: function (_fc, _fd, _fe) {
            var _ff = $(this).tree("options");
            if (!_ff.url) {
                return false;
            }
            $.ajax({
                type: _ff.method, url: _ff.url, data: _fc, dataType: "json", success: function (data) {
                    _fd(data);
                }, error: function () {
