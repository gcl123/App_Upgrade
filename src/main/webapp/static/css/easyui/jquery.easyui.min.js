...
(function ($) {
    ...
    $.fn.droppable.defaults = {
        accept: null, onDragEnter: function (e, _41) {
...
(function ($) {
    ...
    $.fn.linkbutton.parseOptions = function (_6a) {
        var t = $(_6a);
        return $.extend({}, $.parser.parseOptions(_6a, ["id", "iconCls", {plain: "boolean"}]), {
            disabled: (t.attr("disabled") ? true : undefined),
            text: $.trim(t.html()),
...
(function ($) {
    ...
    function _a6(_a7) {
        ...
        _a9.find("div.tree-node").draggable({
            disabled: false, revert: true, cursor: "pointer", proxy: function (_aa) {
            ...
            accept: "div.tree-node", onDragOver: function (e, _ac) {
                var _ad = _ac.pageY;
    ...
    $.fn.tree.defaults = {
        ...
        loader: function (_170, _171, _172) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _170, dataType: "json", success: function (data) {
                    _171(data);
                }, error: function () {
...
(function ($) {
    ...
    $.fn.progressbar.defaults = {
        width: "auto", value: 0, text: "{value}%", onChange: function (_185, _186) {
        }
    };
})(jQuery);
(function ($) {
    ...
    function _19a(_19b) {
        ...
        if (_19c.options.href && (!_19c.isLoaded || !_19c.options.cache)) {
            ...
            $.ajax({
                url: _19c.options.href, cache: false, success: function (data) {
...
(function ($) {
    ...
    function _1e8(_1e9) {
        ...
        _1ea.window.resizable({
            disabled: _1ea.options.resizable == false, onStartResize: function (e) {
...
(function ($) {
    ...
    function _1f7(_1f8) {
        ...
        opts.content = null;
        _1f9.panel({
            closed: opts.closed, cache: opts.cache, href: _1fd, content: _1fe, onLoad: function () {
                if (opts.height == "auto") {
                    $(_1f8).window("resize");
                }
...
(function ($) {
    ...
    $.fn.accordion.defaults = {
        width: "auto", height: "auto", fit: false, border: true, animate: true, onSelect: function (_266, _267) {
...
(function ($) {
    ...
    $.fn.tabs = function (_2c0, _2c1) {
        ...
        return this.each(function () {
            ...
            if (_2c2) {
                ...
                $.data(this, "tabs", {
                    options: $.extend({}, $.fn.tabs.defaults, $.fn.tabs.parseOptions(this), _2c0),
                    tabs: [],
                    selectHis: []
                });
                _28b(this);
    ...
    $.fn.tabs.parseOptions = function (_2cb) {
        return $.extend({}, $.parser.parseOptions(_2cb, ["width", "height", "tools", {
            fit: "boolean",
            border: "boolean",
            plain: "boolean"
        }]));
...
(function ($) {
    ...
    function _2e5(_2e6, _2e7, el) {
        ...
        if (pp.panel("options").split) {
            ...
            _2eb.resizable({
                handles: _2ec, onStartResize: function (e) {
                    _2d9 = true;
    ...
    function _2f6(_2f7, _2f8, _2f9) {
        ...
        function _2fe() {
            ...
            if (_2f8 == "east") {
                return {
                    resizeC: {width: _2fa.center.panel("options").width + _2fa["east"].panel("options").width - 28},
                    expand: {left: cc.width() - _2fa["east"].panel("options").width},
                    expandP: {
                ...
                if (_2f8 == "west") {
                    return {
                        resizeC: {
                            width: _2fa.center.panel("options").width + _2fa["west"].panel("options").width - 28,
                            left: 28
                        },
                        expand: {left: 0},
                        expandP: {
                        ...
                        collapse: {left: -_2fa["west"].panel("options").width}
                    };
                } else {
                    if (_2f8 == "north") {
                        var hh = cc.height() - 28;
                        ...
                        return {
                            ...
                            collapse: {top: -_2fa["north"].panel("options").height}
                        };
                    } else {
                        if (_2f8 == "south") {
                            var hh = cc.height() - 28;
                            ...
                            return {
                                resizeC: {height: hh},
                                expand: {top: cc.height() - _2fa["south"].panel("options").height},
                ...
                if (_302 == "west" && _303.expandWest) {
                    ...
                    if (_302 == "north" && _303.expandNorth) {
                        ...
                        if (_302 == "south" && _303.expandSouth) {
                            return {
                                collapse: {top: cc.height()},
                                expand: {top: cc.height() - _303["south"].panel("options").height}
                            };
                        }
                    }
                }
...
(function ($) {
    ...
    $.fn.menubutton.parseOptions = function (_34e) {
        var t = $(_34e);
        return $.extend({}, $.fn.linkbutton.parseOptions(_34e), $.parser.parseOptions(_34e, ["menu", {
            plain: "boolean",
            duration: "number"
        }]));
    };
...
(function ($) {
    ...
    $.fn.splitbutton.parseOptions = function (_359) {
        var t = $(_359);
        return $.extend({}, $.fn.linkbutton.parseOptions(_359), $.parser.parseOptions(_359, ["menu", {
            plain: "boolean",
            duration: "number"
        }]));
    };
...
(function ($) {
        ...
        return this.each(function () {
            ...
            if (_36f) {
                ...
                _36f = $.data(this, "searchbox", {
                    options: $.extend({}, $.fn.searchbox.defaults, $.fn.searchbox.parseOptions(this), _36d),
                    searchbox: init(this)
                });
            }
            _35f(this);
    ...
    $.fn.searchbox.parseOptions = function (_372) {
        var t = $(_372);
        return $.extend({}, $.parser.parseOptions(_372, ["width", "prompt", "menu"]), {
            value: t.val(),
            searcher: (t.attr("searcher") ? eval(t.attr("searcher")) : undefined)
        });
    };
    $.fn.searchbox.defaults = {
        width: "auto", prompt: "", value: "", menu: null, searcher: function (_373, name) {
        }
    };
})(jQuery);
(function ($) {
...
(function ($) {
    function _392(_393, _394) {
        ...
        var _396 = $("<iframe id=" + _395 + " name=" + _395 + "></iframe>").attr("src", window.ActiveXObject ? "javascript:false" : "about:blank").css({
            position: "absolute",
            top: -1000,
            left: -1000
        });
    ...
    function load(_398, data) {
        ...
        if (typeof data == "string") {
            ...
            $.ajax({
                url: data, data: _399, dataType: "json", success: function (data) {
                    _39a(data);
                }, error: function () {
...
(function ($) {
        ...
        return this.each(function () {
            ...
            if (_3bd) {
                ...
                _3bd = $.data(this, "numberbox", {
                    options: $.extend({}, $.fn.numberbox.defaults, $.fn.numberbox.parseOptions(this), _3ba),
                    field: init(this)
                });
                $(this).removeAttr("disabled");
    ...
    $.fn.numberbox.parseOptions = function (_3c0) {
        var t = $(_3c0);
        return $.extend({}, $.fn.validatebox.parseOptions(_3c0), $.parser.parseOptions(_3c0, ["decimalSeparator", "groupSeparator", "prefix", "suffix", {
            min: "number",
            max: "number",
            precision: "number"
...
(function ($) {
        ...
        return this.each(function () {
            ...
            if (_3f9) {
                ...
                _3f9 = $.data(this, "spinner", {
                    options: $.extend({}, $.fn.spinner.defaults, $.fn.spinner.parseOptions(this), _3f6),
                    spinner: init(this)
                });
                $(this).removeAttr("disabled");
            }
    ...
    $.fn.spinner.parseOptions = function (_3fd) {
        var t = $(_3fd);
        return $.extend({}, $.fn.validatebox.parseOptions(_3fd), $.parser.parseOptions(_3fd, ["width", "min", "max", {
            increment: "number",
            editable: "boolean"
...
(function ($) {
    ...
    $.fn.timespinner.parseOptions = function (_421) {
        return $.extend({}, $.fn.spinner.parseOptions(_421), $.parser.parseOptions(_421, ["separator", {
            showSeconds: "boolean",
            highlight: "number"
        }]));
    };
...
(function ($) {
    ...
    function _440(_441, _442) {
        ...
        return {
            ...
            dc: {
                ...
                view1: _449,
                view2: _44a,
                header1: _449.children("div.datagrid-header").children("div.datagrid-header-inner"),
                header2: _44a.children("div.datagrid-header").children("div.datagrid-header-inner"),
    ...
    function _44f(_450) {
        ...
        _452.panel($.extend({}, opts, {
            id: null, doSize: false, onResize: function (_453, _454) {
                setTimeout(function () {
            ...
            if (col && col.editor) {
                ...
                if (_4fc) {
                    ...
                    $.data(cell[0], "datagrid.editor", {
                        actions: _4fc,
                        target: _4fc.init(cell.find("td"), _4fb),
                        field: _4f9,
                        type: _4fa,
                        oldHtml: _4fd
                    });
    ...
    $.fn.datagrid.parseOptions = function (_59c) {
        var t = $(_59c);
        return $.extend({}, $.fn.panel.parseOptions(_59c), $.parser.parseOptions(_59c, ["url", "toolbar", "idField", "sortName", "sortOrder", "pagePosition", {
            fitColumns: "boolean",
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        loader: function (_5c7, _5c8, _5c9) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _5c7, dataType: "json", success: function (data) {
                    _5c8(data);
                }, error: function () {
...
(function ($) {
    function _5f0(_5f1) {
        ...
        $(_5f1).datagrid($.extend({}, opts, {
            cls: "propertygrid", view: (opts.showGroup ? _5f2 : undefined), onClickRow: function (_5f3, row) {
    ...
    var _5f2 = $.extend({}, $.fn.datagrid.defaults.view, {
...
(function ($) {
    ...
    $.fn.treegrid = function (_691, _692) {
        ...
        return this.each(function () {
            ...
            if (_694) {
                ...
                $.data(this, "treegrid", {
                    options: $.extend({}, $.fn.treegrid.defaults, $.fn.treegrid.parseOptions(this), _691),
                    data: []
                });
            }
            _61d(this);
    ...
    var _69a = $.extend({}, $.fn.datagrid.defaults.view, {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        treeField: null, animate: false, singleSelect: true, view: _69a, loader: function (_6c7, _6c8, _6c9) {
            var opts = $(this).treegrid("options");
            if (!opts.url) {
                return false;
            }
            $.ajax({
                type: opts.method, url: opts.url, data: _6c7, dataType: "json", success: function (data) {
                    _6c8(data);
                }, error: function () {
...
(function ($) {
        ...
        return this.each(function () {
            ...
            if (_716) {
                ...
                _716 = $.data(this, "combo", {
                    options: $.extend({}, $.fn.combo.defaults, $.fn.combo.parseOptions(this), _714),
                    combo: r.combo,
                    panel: r.panel,
                    previousValue: null
                });
    ...
    $.fn.combo.parseOptions = function (_71b) {
        var t = $(_71b);
        return $.extend({}, $.fn.validatebox.parseOptions(_71b), $.parser.parseOptions(_71b, ["width", "separator", {
            panelWidth: "number",
            editable: "boolean",
...
(function ($) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        valueField: "value", textField: "text", mode: "local", method: "post", url: null, data: null, keyHandler: {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _754, dataType: "json", success: function (data) {
                    _755(data);
                }, error: function () {
...
(function ($) {
        ...
        return this.each(function () {
            ...
            if (_7e6) {
                ...
                _7e6 = $.data(this, "slider", {
                    options: $.extend({}, $.fn.slider.defaults, $.fn.slider.parseOptions(this), _7e4),
                    slider: init(this)
                });
                $(this).removeAttr("disabled");
            }
    ...
    $.fn.slider.parseOptions = function (_7e9) {
        var t = $(_7e9);
        return $.extend({}, $.parser.parseOptions(_7e9, ["width", "height", "mode", {
            showTip: "boolean",
            min: "number",
            max: "number",
            step: "number"
